define([
	...
	module.registerDirective('waMenu', [
		'$state',
		'$rootScope',
				...
				link: function (scope, element, attrs) {
					...
					$collapsible.each(function (idx, li) {
						...
						$li
							.on('click', '>a', function (e) {
								...
								$li.siblings('.open').waCollapseToggle();
					...
					element.on('click', 'a[data-ui-sref]', function (e) {
						...
						$(this)
							...
							.each(function () {
								$(this).siblings('li.open').waCollapseToggle();
					...
					scope.$on('$smartLayoutMenuOnTop', function (event, menuOnTop) {
						if (menuOnTop) {
							$collapsible.filter('.open').waCollapseToggle();
						}
					});
